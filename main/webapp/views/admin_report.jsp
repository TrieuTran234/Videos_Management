...
<body>
	...
	<main class="container">
		<header class="row pt-5 pb-3">
			...
			<div class="col-8">
				<h1 style="padding-left: 30px;">Management</h1>
			</div>
			<div class="col-3">
			...
			<div class="u-custom-menu u-nav-container">
				<ul class="u-nav u-spacing-30 u-unstyled u-nav-1">
					<li class="u-nav-item"><a
						...
						href="home.html" style="padding: 2px 42px;">Home</a></li>
					<li class="u-nav-item"><a
						class="u-border-4 u-border-active-grey-75 u-border-hover-grey-75 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-grey-90"
						style="padding: 2px 42px;">About us</a></li>
					<li class="u-nav-item"><a
						class="u-border-4 u-border-active-grey-75 u-border-hover-grey-75 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-grey-90"
						style="padding: 2px 42px;">Contact Us</a></li>
					<li class="u-nav-item"><a
						class="u-border-4 u-border-active-grey-75 u-border-hover-grey-75 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-grey-90"
						style="padding: 2px 42px;">My Favorites</a></li>
					<li class="u-nav-item"><a
						class="u-border-4 u-border-active-grey-75 u-border-hover-grey-75 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-grey-90"
						href="My-Account.html" style="padding: 2px 40px 2px 42px;">My
							Account</a>
						<div class="u-nav-popup">
							<ul
								class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-nav-2">
								<li class="u-nav-item"><a
									class="u-button-style u-nav-link u-white" href="login.jsp">Login</a>
								</li>

								<li class="u-nav-item"><a
									class="u-button-style u-nav-link u-white" href="register.jsp">Registration</a>
								</li>

								<li class="u-nav-item"><a
									class="u-button-style u-nav-link u-white" href="chancePass.jsp">Chance
										Password</a></li>
								<li class="u-nav-item"><a
									class="u-button-style u-nav-link u-white"
									href="editProfile.jsp">Edit Profile</a></li>
								<li class="u-nav-item"><a
									class="u-button-style u-nav-link u-white">Logoff</a></li>
							</ul>
						</div></li>
				</ul>
			</div>
		...
		<div>
			...
			<div class="tab-content" id="nav-tabContent">
				<div class="tab-pane fade show active" id="videoEditting"
					...
					<jsp:include page="editVideo.jsp"></jsp:include>
				</div>
				...
				<div class="tab-pane fade" id="shareFriends" role="tabpanel"
					...
					<jsp:include page="/views/videoList.jsp"></jsp:include>
				</div>
			...
			<div
				...
				<div class="u-gutter-0 u-layout">
									...
									<div class="u-block">
										<div class="u-block-container u-clearfix">
											...
											<div class="u-block-content u-text">
												...
												Block contedasdsadnt. Lorem ipsum dolor sit amet,
                    ...
                    c0-6.7,3.1-17,17-17h12.5v13.9H73.5z"></path>
                                            </svg></span> </a> <a class="u-social-url"
										title="twitter" target="_blank" href=""><span
										class="u-icon u-social-icon u-social-twitter u-icon-2"><svg
											...
											<svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0"
												id="svg-f5e8">
                                                <circle
													fill="currentColor" class="st0" cx="56.1" cy="56.1" r="55">
                                                </circle>
                                                <path fill="#FFFFFF"
                    ...
                    c2.7-0.3,5.3-1,7.7-2.1C88.7,43,86.4,45.4,83.8,47.3z"></path>
										...
										title="instagram" target="_blank" href=""><span
                    ...
                    c5.5,0,9.9,4.5,9.9,9.9V73.3z"></path>
										...
										title="linkedin" target="_blank" href=""><span

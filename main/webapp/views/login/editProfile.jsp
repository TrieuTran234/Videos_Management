			...
			<form method="POST" class="register-form" id="register-form">
				...
				<div class="form-group">
					<label for="name"><i
						...
						type="text" name="name" id="name"  value="${user.userName}" placeholder="User Name" />
				</div>
				...
				<div class="form-group">
					<label for="newpass"><i class="zmdi zmdi-lock"></i></label> <input
						type="password" name="newpass" id="newpass" placeholder="New Password" />
				</div>
				...
				<div class="form-group">
					<label for="email"><i class="zmdi zmdi-email"></i></label> <input
						type="text" name="email" id="email" value="${user.email}" placeholder="Email Address" />
				</div>
				<c:if test="${not empty messageEdit}">
					<div class="alert alert-success">${messageEdit}</div>
				</c:if>

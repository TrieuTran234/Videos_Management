		...
		<nav class="row"
			...
			<div class="u-custom-menu u-nav-container">
				<ul class="u-nav u-spacing-30 u-unstyled u-nav-1">
					...
					<li class="u-nav-item"><a
						class="u-border-4 u-border-active-grey-75 u-border-hover-grey-75 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-grey-90"
						href="/assignment/views/admin_NDung/index_user.jsp" style="padding: 2px 42px;">About
							us</a></li>
					<li class="u-nav-item"><a
						class="u-border-4 u-border-active-grey-75 u-border-hover-grey-75 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-grey-90"
						href="/assignment/views/admin_NDung/index_user.jsp" style="padding: 2px 42px;">Contact
							Us</a></li>
					<li class="u-nav-item"><a
						class="u-border-4 u-border-active-grey-75 u-border-hover-grey-75 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-grey-90"
						href="/assignment/views/admin_NDung/index_user.jsp" style="padding: 2px 42px;">My
							Favorites</a></li>
					<li class="u-nav-item"><a
						class="u-border-4 u-border-active-grey-75 u-border-hover-grey-75 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-grey-90"
				...
				<div class="u-gutter-0 u-layout">
								...
								<div class="u-social-icons u-spacing-10 u-social-icons-1"
									...
									<a class="u-social-url" title="facebook" target="_blank"
										...
										class="u-icon u-social-facebook u-social-icon u-icon-1"><svg
												...
												viewBox="0 0 112 112" x="0" y="0" id="svg-d108">
                                                <circle
                    ...
                    c0-6.7,3.1-17,17-17h12.5v13.9H73.5z"></path>
										...
										class="u-icon u-social-icon u-social-twitter u-icon-2"><svg
												...
												viewBox="0 0 112 112" x="0" y="0" id="svg-f5e8">
                                                <circle
                    ...
                    c2.7-0.3,5.3-1,7.7-2.1C88.7,43,86.4,45.4,83.8,47.3z"></path>
										...
										class="u-icon u-social-icon u-social-instagram u-icon-3"><svg
												...
												viewBox="0 0 112 112" x="0" y="0" id="svg-b5d6">
                                                <circle
													fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
                                                <path fill="#FFFFFF"
                    ...
                    c5.5,0,9.9,4.5,9.9,9.9V73.3z"></path>
										...
										class="u-icon u-social-icon u-social-linkedin u-icon-4"><svg
												...
												viewBox="0 0 112 112" x="0" y="0" id="svg-32fb">
                                                <circle
													fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
                                                <path fill="#FFFFFF"
